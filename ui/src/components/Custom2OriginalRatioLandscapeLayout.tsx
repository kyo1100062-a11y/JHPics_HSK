...
interface Custom2OriginalRatioLandscapeLayoutProps {
  slots: ImageSlotType[]
...
function Custom2OriginalRatioLandscapeLayout({
  slots,
  onImageSelect,
  onDelete,
  onEdit,
...
}: Custom2OriginalRatioLandscapeLayoutProps) {
...
export default Custom2OriginalRatioLandscapeLayout
